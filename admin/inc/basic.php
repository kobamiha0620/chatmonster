...
<div class="theme_option_field cf">
    ...
    <p><?php _e( 'This color is used for the button color of the archive page pager, the background color when hovering the category icon, and the font color when hovering the category link.', 'tcd-w' ); ?></p>
	...
	<input class="c-color-picker" name="dp_options[tertiary_color]" type="text" value="<?php echo esc_attr( $dp_options['tertiary_color'] ); ?>" data-default-color="<?php echo esc_attr( $dp_default_options['tertiary_color'] ); ?>">
...
<h3 class="theme_option_headline"><?php _e( 'Facebook OGP setting', 'tcd-w' ); ?></h3>
	<p><?php _e( 'OGP is a mechanism for correctly conveying page information.', 'tcd-w' ); ?><br><a href="https://tcd-theme.com/2018/01/facebook_app_id.html" target="_blank"><?php _e( 'Information about Facebook app ID.', 'tcd-w' ); ?></a></p>
...
<div class="theme_option_field cf">
	<h3 class="theme_option_headline"><?php _e( 'X Cards setting', 'tcd-w' ); ?></h3>
	<p><?php _e( 'This theme requires Facebook OGP settings to use X cards.', 'tcd-w' ); ?></p>
	<div class="theme_option_input">
		<p><label><input name="dp_options[use_twitter_card]" type="checkbox" value="1" <?php checked( 1, $dp_options['use_twitter_card'] ); ?>> <?php _e( 'Use X Cards', 'tcd-w' ); ?></label></p>
...
<div class="theme_option_field cf">
	...
	<div class="theme_option_message"><?php echo __( '<p>Facebook like button is displayed only when you select Button type 5 (Default button).</p><p>RSS button is not displayed if you select Button type 5 (Default button).</p>', 'tcd-w' ); ?></div>
	<div class="theme_option_input">
