...
<div class="theme_option_field cf">
	...
	<div class="theme_option_message">
		<p><?php _e( 'By pressing the "export" button, you can download TCD theme options setting file as json file. Example of setting file name: tcd_theme_options-export-WordPress theme "FAMOUS" - FAMOUS - 20180930.json "', 'tcd-w' ); ?></p>
	...
	<ul>
		...
		<li><label style="vertical-align: baseline;"><input name="tcd-tools-reset-sample-menus" type="checkbox" value="1"><?php _e( 'Add sample menu', 'tcd-w' ); ?></label> <small class="description"><?php _e( 'Note: Sample menu will not be added if the \"Global menu (front page)\", \"Global menu (sub page)\", \"Footer menu\" or \"Sample menu\" already exist.', 'tcd-w' ); ?></small></li>
