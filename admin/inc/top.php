<?php
global $dp_options, $dp_default_options, $header_content_type_options, $slider_content_type_options, $slider_content_type_mobile_options, $slide_effect_type_options, $text_align_options;
...
<div class="theme_option_field cf">
    ...
    <div class="theme_option_message"><?php echo __( '<p>Image slider:You can set 3 slides or 1 image as fixed header.</p><p>Video:You can display MP4 format videos.</p><p>Youtube:You can display Youtube videos.</p>', 'tcd-w' ); ?></div>
...
?>
	<div class="sub_box cf">
		...
		<div class="sub_box_content">
			...
			<input class="large-text" type="text" name="dp_options[slider_url<?php echo $i; ?>]" value="<?php echo esc_attr( $dp_options['slider_url' . $i] ); ?>">
			<p><label><input name="dp_options[slider_target<?php echo $i; ?>]" type="checkbox" value="1" <?php checked( 1, $dp_options['slider_target' . $i] ); ?>><?php _e( 'Open link in new window', 'tcd-w' ); ?></label></p>
...
?>
	...
	<h4 class="theme_option_headline2"><?php _e( 'Slide effect type', 'tcd-w' ); ?></h4>
    <p><?php _e( 'Use effect to split the image into stripes when slides change. Please choose from 3 types with different impressions.', 'tcd-w' ); ?></p>
	<fieldset class="cf select_type2">
		<?php foreach ( $slide_effect_type_options as $option ) : ?>
		<label><input type="radio" name="dp_options[slide_effect_type]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php checked( $dp_options['slide_effect_type'], $option['value'] ); ?>><?php echo $option['label']; ?></label>
		<?php endforeach; ?>
	</fieldset>
	<input type="submit" class="button-ml ajax_button" value="<?php _e( 'Save Changes', 'tcd-w' ); ?>">
</div>
...
<div class="theme_option_field cf header_content-type2 header_content-type3" style="<?php if ( 'type1' == $dp_options['header_content_type'] ) echo 'display: none;'; ?>">
	...
	<div class="header_content-type3" style="<?php if ( 'type3' != $dp_options['header_content_type'] ) echo 'display: none;'; ?>">
		...
		<p>	<?php _e( 'The screen ratio for video is assumed to be 16:9.', 'tcd-w' ); ?></p>
	...
	<h4 class="theme_option_headline2"><?php _e( 'Display alternate images on smartphones', 'tcd-w' ); ?></h4>
	...
	<label for="header_video_sp_image">
	<input id="header_video_sp_image" type="checkbox" name="dp_options[header_video_sp_image]" value="1" <?php checked( $dp_options['header_video_sp_image'], 1 ); ?>><?php _e( 'Display alternate images on smartphones', 'tcd-w' ); ?></label>
