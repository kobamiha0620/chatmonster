...
add_filter( 'manage_' . $dp_options['information_slug'] . '_posts_columns', 'manage_columns', 5 ); // ニュース
add_filter( 'manage_' . $dp_options['works_slug'] . '_posts_columns', 'manage_columns', 5 ); // works
add_filter( 'manage_' . $dp_options['voice_slug'] . '_posts_columns', 'manage_columns', 5 ); // voice
