...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_famous.xml';	
    $db_cache_field = 'famous-contempo-notifier-cache';
    $db_cache_field_last_updated = 'famous-contempo-notifier-last-updated';
