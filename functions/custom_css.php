...
function add_css_to_post_custom_css_hooks() {
	...
	add_meta_box( 'custom_css', __( 'Custom CSS for this post', 'tcd-w' ), 'add_css_to_post_custom_css_input', array( 'post', 'page', $dp_options['information_slug'], $dp_options['works_slug'] ), 'normal', 'high' );
}
